    ...
    <WarmBg>
      <div className="flex flex-col items-center px-6 py-12 text-center">
        ...
        <div className="flex items-center gap-3 mb-10">
          ...
          <span className="text-white font-black text-2xl tracking-tight drop-shadow">CanteenX</span>
        </div>
        ...
        <div className="w-full max-w-5xl flex flex-col lg:flex-row gap-6 items-center">
          ...
          <div className="flex-1 text-white px-4 lg:px-8 text-center lg:text-left">
            ...
            <div className="flex items-center gap-3 mb-10 justify-center lg:justify-start">
              ...
              <span className="text-white font-black text-2xl tracking-tight drop-shadow-lg">CanteenX</span>
            </div>
            ...
            <p className="mt-12 text-white/30 text-xs hidden lg:block">CanteenX © {new Date().getFullYear()}</p>
          </div>
          ...
          <div className="w-full max-w-md">
            ...
            <p className="text-center text-white/30 text-xs mt-4 lg:hidden">CanteenX © {new Date().getFullYear()}</p>
          </div>
