...
from apps.cms.models import MenuItem, GuestOrder, CanteenLocation
...
class MenuViewSet(ViewSet):
    ...
    def available(self, request):
        ...
        queryset = MenuItem.objects.filter(live=True, days__contains=[day])
        if slot:
    ...
    def slots(self, request):
        slots = [choice[0] for choice in MenuItem.SLOT_CHOICES]
