...
class OrderStatus:
    ...
    # Valid forward transitions — enforced at service layer
    TRANSITIONS = {
...
class Order(models.Model):
    ...
    order_code = models.CharField(
        ...
        help_text="e.g. CMS-A4X9Q2. Generated on creation by order service.",
    )
    ...
    def can_cancel(self) -> bool:
        """Employee can cancel only from PLACED status."""
