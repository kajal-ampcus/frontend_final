...
# DRF
REST_FRAMEWORK = {
    # Custom authentication handles both Employee/Admin tokens (with user_id)
    # and Device tokens (Kitchen/Counter with device_user_id)
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'apps.common.authentication.CombinedJWTAuthentication',
    ],
